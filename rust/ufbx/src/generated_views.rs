...
impl<M: Mode> View<SkinDeformer, M> {
    ...
    pub(crate) fn skinning_method(&self) -> SkinningMethod {
        // SAFETY: by-value read of the `skinning_method` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn clusters(&self) -> RefList<SkinCluster> {
        // SAFETY: by-value read of the `clusters` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn vertices(&self) -> List<SkinVertex> {
        // SAFETY: by-value read of the `vertices` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
        unsafe { ptr::read(&raw const (*self.as_ptr()).vertices) }
    }
    #[inline(always)]
    ...
    pub(crate) fn weights(&self) -> List<SkinWeight> {
        // SAFETY: by-value read of the `weights` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn max_weights_per_vertex(&self) -> usize {
        // SAFETY: by-value read of the `max_weights_per_vertex` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn num_dq_weights(&self) -> usize {
        // SAFETY: by-value read of the `num_dq_weights` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn dq_vertices(&self) -> List<u32> {
        // SAFETY: by-value read of the `dq_vertices` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn dq_weights(&self) -> List<Real> {
        // SAFETY: by-value read of the `dq_weights` field; the viewed `SkinDeformer`
        // is valid and live per this view's mint vouch.
...
impl<M: Mode> View<SubdivisionResult, M> {
    ...
    pub(crate) fn result_memory_used(&self) -> usize {
        // SAFETY: by-value read of the `result_memory_used` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn temp_memory_used(&self) -> usize {
        // SAFETY: by-value read of the `temp_memory_used` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn result_allocs(&self) -> usize {
        // SAFETY: by-value read of the `result_allocs` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn temp_allocs(&self) -> usize {
        // SAFETY: by-value read of the `temp_allocs` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn source_vertex_ranges(&self) -> List<SubdivisionWeightRange> {
        // SAFETY: by-value read of the `source_vertex_ranges` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn source_vertex_weights(&self) -> List<SubdivisionWeight> {
        // SAFETY: by-value read of the `source_vertex_weights` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn skin_cluster_ranges(&self) -> List<SubdivisionWeightRange> {
        // SAFETY: by-value read of the `skin_cluster_ranges` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
    ...
    pub(crate) fn skin_cluster_weights(&self) -> List<SubdivisionWeight> {
        // SAFETY: by-value read of the `skin_cluster_weights` field; the viewed `SubdivisionResult`
        // is valid and live per this view's mint vouch.
